# nvim-treesitter-queries-sourcepawn

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-sourcepawn/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-sourcepawn/actions/workflows/validate.yml)

Neovim tree-sitter queries for **sourcepawn**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-sourcepawn",
...
- [ ] Changes are scoped to `sourcepawn` — do not include files for other languages
